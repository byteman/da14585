...
static const struct attm_desc lans_att_db[LNS_IDX_NB] =
{
    ...
    [LNS_IDX_SVC]                  =   {ATT_DECL_PRIMARY_SERVICE, PERM(RD, ENABLE), 0},

    // LN Feature Characteristic Declaration
    [LNS_IDX_LN_FEAT_CHAR]         =   {ATT_DECL_CHARACTERISTIC, PERM(RD, ENABLE), 0},
    ...
    [LNS_IDX_LOC_SPEED_NTF_CFG]    =   {ATT_DESC_CLIENT_CHAR_CFG, PERM(RD, ENABLE) | PERM(WR, ENABLE) | PERM(WRITE_REQ, ENABLE), 0},

    // Position Quality Characteristic Declaration
    [LNS_IDX_POS_Q_CHAR]           =   {ATT_DECL_CHARACTERISTIC, PERM(RD, ENABLE), 0},
    ...
    [LNS_IDX_LN_CTNL_PT_VAL]       =   {ATT_CHAR_LN_CNTL_PT, PERM(IND, ENABLE) | PERM(WR, ENABLE) | PERM(WRITE_REQ, ENABLE),
    ...
    [LNS_IDX_LN_CTNL_PT_IND_CFG]   =   {ATT_DESC_CLIENT_CHAR_CFG, PERM(RD, ENABLE) | PERM(WR, ENABLE) | PERM(WRITE_REQ, ENABLE), 0},
    ...
    [LNS_IDX_NAVIGATION_NTF_CFG]    =   {ATT_DESC_CLIENT_CHAR_CFG, PERM(RD, ENABLE) | PERM(WR, ENABLE) | PERM(WRITE_REQ, ENABLE), 0},
};
