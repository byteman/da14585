...
#else
 __INLINE uint16_t l2cm_get_buffer_size(uint16_t conidx)
 {
//     return llc_env[conidx]->connEffectiveMaxRxOctets<llc_env[conidx]->connEffectiveMaxTxOctets?
//			 llc_env[conidx]->connEffectiveMaxRxOctets:llc_env[conidx]->connEffectiveMaxTxOctets;
     //return llc_env[conidx]->connEffectiveMaxTxOctets;
