...
const SPI_FLASH_DEVICE_PARAMETERS_BY_JEDEC_ID_t SPI_FLASH_KNOWN_DEVICES_PARAMETERS_LIST[] =
{
    ...
    {MX25R1035F_JEDEC_ID, MX25R1035F_JEDEC_ID_MATCHING_BITMASK, MX25R1035F_TOTAL_FLASH_SIZE, MX25R1035F_PAGE_SIZE, MX25R1035F_MEM_PROT_BITMASK, MX25R1035F_MEM_PROT_NONE},
...
int8_t spi_flash_auto_detect(void)
{
    ...
    if ((jedec_id == 0x00000000) || (jedec_id == 0xFFFFFFFF))
    {
        ...
        return SPI_FLASH_AUTO_DETECT_ERROR;
    }
