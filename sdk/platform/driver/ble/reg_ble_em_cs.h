...
__INLINE void ble_link_pack(int elt_idx, uint8_t rxthr, uint8_t txcrypten, uint8_t rxcrypten, uint8_t linklbl)
{
...
__INLINE void ble_link_unpack(int elt_idx, uint8_t* rxthr, uint8_t* txcrypten, uint8_t* rxcrypten, uint8_t* linklbl)
{
...
__INLINE void ble_dmpriocntl_pack(int elt_idx, uint8_t prioincstep, uint8_t minprio, uint8_t conflict)
{
