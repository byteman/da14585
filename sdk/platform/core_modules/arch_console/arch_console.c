...
static printf_msg *printf_msg_list __attribute__((section("retention_mem_area0"), zero_init));
static bool defer_sending __attribute__((section("retention_mem_area0"), zero_init));
