...
#if BT_EMB_PRESENT // TODO [VLE] variable size: structure definition + special pack/unpack + handler
...
#if BLE_EMB_PRESENT || BLE_HOST_PRESENT // TODO [LT] find solution to make it generic or hide LE commands from BT single mode
