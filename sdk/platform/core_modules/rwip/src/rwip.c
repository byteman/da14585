...
uint32_t retained_BLE_EM_BASE_REG __attribute__((section("retention_mem_area0"), zero_init));
 ...
 */
    ...
    uint32_t dbg_rwip_sleep_step __attribute__((section("retention_mem_area0"), zero_init));
